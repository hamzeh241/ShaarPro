...
public class Tab_Archive_Homes extends Fragment implements IBase {
    public static final String TAG="Tab_Archive_Homes";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.tab_archive_homes,container,false);
    ...
    void setVal() {
        ...
        String Url = Api + "Item/getUserProitem?Id=" + Id + "&Kind=3&Page=" + Page;
